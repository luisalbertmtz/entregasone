        ...
        <div class="offcanvas-body">
          <ul class="navbar-nav flex-grow-1 pe-3">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navBarEntregas">
                <li><a class="dropdown-item" href="<?php echo PATH?>modulos/fpdf/reporteEntrega.php" target="_blank" rel="noopener noreferrer"><i class="bi bi-file-earmark-bar-graph me-3"></i>Reporte completo Blancos sucios</a></li>
