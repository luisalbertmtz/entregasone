...
<div class="container mt-5" class="table-responsive">
    <div class="row justify-content-center" class="responsive">
			...
			if(isset($_GET["status"])){
                ...
                ?>
					...
					<div class="alert alert-info">
							<strong>Entrega cancelado</strong>
						</div>
						<?php
                header('Refresh: 2; URL=listar.php');
                ?>
		...
		<form method="post" action="agregarAlCarrito.php">
			...
			<input autocomplete="on" autofocus class="form-control" name="codigo" required type="text" id="codigo" placeholder="Escribe nombre de producto">
